<template>
    ...
    >
      ...
      <h3 class = "customerRegisterTitle">
        新用户注册
      </h3>
  
      <p class = "customerRegisterDetail">
        吃饱了才有力气减肥!
      </p>
  
      <el-form-item prop="username" class = "idInputBox">
        <el-input
          v-model="input"
          type="id"
          placeholder="用户名"
          size = "large"
          class = "idInputBoxClass"
        >
          <template #prefix>
      ...
      <el-form-item prop="address" class = "addressInputBox">
        <el-input
          v-model="input"
          type="address"
          placeholder="设置收获地址"
          size = "large"
          class = "addressInputBoxClass"  
        >
          <template #prefix>
